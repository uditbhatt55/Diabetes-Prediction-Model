...
with col1:
    ...
    gender = st.selectbox(
        ...
        index=0,
        help="Select the patient's gender. Pregnancy option appears only for females."
    )

    # --- Conditional Pregnancies Input ---
    if gender == "Female":
        ...
        Pregnancies = 0  # auto-set for males or not specified
...
<b style='color:#FF4B4B;'>👨🏻‍⚕️ Thank you for visiting! Come back soon! ⚕️</b><br><br>

<b style='color:red; font-size:16px;'>
⚠️ Advisory: This prediction is generated by a machine learning model and is not 100% accurate.<br>
Please consult a certified medical professional for proper diagnosis and treatment.<br>
